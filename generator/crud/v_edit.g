            ...
            <div class="well col-lg-8">
              <div class="form-actions">
                <div class="panel panel-default">
                  <div class="panel-heading">Editar {{model}}</div>
                  <div class="panel-body">
                    ...
                    <form id="{{action}}_form" role="form">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control form-input" name="ejemplo" value="<?= $data['ejemplo'] ?>" placeholder="Escribe algo..." />
                      </div>
                      <div class="col-lg-12">
                        <div class="form-group">
...
<script src="views/app/js/{{action}}/editar.js"></script>
</body>
